...
@RestController
@RequestMapping("/api/v1/alertas_de_carros_em_situacao_irregular_para_usuarios")
public class AlertasDeCarrosEmSituacaoIrregularParaUsuariosRest {
	...
	public ResponseEntity<AlertaDeCarroEmSituacaoIrregularParaUsuarioDto> cadastrar(@RequestBody @Valid
		...
		URI uri = uriBuilder.path("/api/v1/alertas_de_carros_em_situacao_irregular_para_usuarios/{id}")
