...
public interface BotDoTelegramRepository extends
	JpaRepository<BotDoTelegram, Long>{

	Page<BotDoTelegram> findByDenominacao(String denominacao, Pageable paginacao);
