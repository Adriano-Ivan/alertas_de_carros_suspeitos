...
public interface CarroEmSituacaoIrregularRepository extends
	JpaRepository<CarroEmSituacaoIrregular, Long>{

	Page<CarroEmSituacaoIrregular> findByPlaca(String placa, Pageable paginacao);
